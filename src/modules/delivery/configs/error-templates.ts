...
export const deliveryErrorTemplates: ErrorTemplateMap = {
	auth: {
		login: {
			ACCOUNT_NOT_FOUND: {
		...
		assign: {
			manager: {
				REASSIGNMENT_CONFLICT: {
					...
					error_toast_btn_action: "/delivery/conflicts/details",
				},
				ACTIVATION_CONFLICT: {
				...
				INVALID_ROLE: {
					...
					error_toast_btn_action: "/delivery/employee/details?id={id}",
				},
	...
	common: {
		VERTICAL_NOT_FOUND: {
			message: "No delivery vertical found!",
			code: 400,
			error_toast_title: "System Error",
			error_toast_description: "The application configuration for the delivery vertical is missing. Please contact system administration.",
		},
		EMPLOYEE_NOT_FOUND: {
