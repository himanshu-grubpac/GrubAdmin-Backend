...
export const deliveryMessageTemplates: MessageTemplateMap = {
	auth: {
		login: {
			SUCCESS: {
	...
	restaurant: {
		create: {
			SUCCESS: {
				...
				message_toast_btn_action: "/delivery/box/list?restaurant_id={id}",
			},
		},
		update: {
			SUCCESS: {
		...
		transfer: {
			SUCCESS: {
				...
				message_toast_btn_action: "/delivery/restaurant/details?id={id}",
			},
			BULK_SUCCESS: {
				...
				message_toast_btn_title: "View details",
				message_toast_btn_action: "/delivery/restaurant/list",
			},
		},
	},
	box: {
		...
		settings: {
			...
			BULK_SUCCESS: {
				...
				message_toast_btn_title: "View details",
				message_toast_btn_action: "/delivery/box/list",
			},
		},
		SECURED: {
			message: "Box secured!",
			...
			message_toast_btn_title: "View details",
			message_toast_btn_action: "/delivery/box/details?id={id}",
		},
		unlock: {
			REQUEST_SENT: {
	...
	employee: {
		create: {
			SUCCESS: {
				...
				message_toast_btn_action: "/delivery/employee/details?id={id}",
			},
		},
		profile: {
			UPDATE_SUCCESS: {
