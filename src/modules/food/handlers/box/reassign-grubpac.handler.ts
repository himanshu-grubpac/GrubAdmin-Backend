...
import { reassignBoxesRequestBodyValidator } from "food/validators/box.validators.ts";
import { reassignVerticalFoodBoxes } from "@/db/actions/box.actions.ts";
...
export const reassignGrubpacHandler = createHandlers(
    ...
    async (context) => {
        ...
        const result = await reassignVerticalFoodBoxes(ids, finalRestaurantId, client_id);
