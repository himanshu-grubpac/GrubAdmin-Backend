...
import { updateVerticalFoodEmployeeById, getUniqueVerticalFoodEmployee } from "@/db/actions/vertical-food-employee.actions";
...
export const updateEmployeeHandler = createHandlers(
    ...
    async (context) => {
        ...
        const oldEmployeeResult = await getUniqueVerticalFoodEmployee({ id });
        ...
        const employee = await updateVerticalFoodEmployeeById({
            id,
            client_id,
            ...nameUpdate,
            ...rest,
